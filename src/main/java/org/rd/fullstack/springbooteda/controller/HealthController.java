...
public class HealthController {
   ...
   /**
    ...
    @Operation(summary = "Get Kafka data and health status.", description = "KafkaDashboard.class")
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Success|OK."),
        @ApiResponse(responseCode = "401", description = "Unauthorized."), 
        @ApiResponse(responseCode = "403", description = "Forbidden."),
    ...
    public ResponseEntity<KafkaDashboard> getKafkaDashboardData() {
        ...
        try {
            ...
            logger.error("Exception getting Kafka data and health status: {}.", ex);
    ...
    public ResponseEntity<FlinkDashboard> getFlinkDashboardData() {
        ...
        try {
            ...
            logger.error("Exception getting Flink data and health status: {}.", ex);
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    @RequestMapping(value = "/hazelcastDashboardData", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Get Hazelcast data and health status.", description = "HazelcastDashboard.class")
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Success|OK."),
        @ApiResponse(responseCode = "401", description = "Unauthorized."), 
        @ApiResponse(responseCode = "403", description = "Forbidden."),
    ...
    public ResponseEntity<HazelcastDashboard> getHazelcastDashboardData() {
        try {
            HazelcastDashboard hazelcastDashboard = hazelcastSandbox.getDashboardData();
            return new ResponseEntity<>(hazelcastDashboard, HttpStatus.OK);
        } catch (Exception ex) {
            logger.error("Exception getting Hazelcast data and health status: {}.", ex);
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
}