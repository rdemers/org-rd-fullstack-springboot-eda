...
public class T1000_DBJPA_UT_Tests {
    ...
    public void personRepositoryDemoTest() {
        ...
        p1 = personRepository
                .saveAndFlush(new Person("firstName",
                    "LastName", new BigDecimal("1000.00")));
    ...
    public void productRepositoryDemoTest() {
        ...
        p1 = productRepository.saveAndFlush(new Product("Coke",
                 "Coka-Cola", new BigDecimal("1.00")));
    ...
    public void inventoryRepositoryDemoTest() {
        ...
        p1 = productRepository.saveAndFlush(new Product("Sprite",
                                 "Sprite", new BigDecimal("1.00")));
    ...
    public void requestRepositoryDemoTest() {
        ...
        pe1 = personRepository.saveAndFlush(new Person("Test4",
                "Test4", new BigDecimal("1000.00")));
        assertNotNull(pe1);

        po1 = productRepository.saveAndFlush(new Product("Product4",
                 "Product4", new BigDecimal("1.00")));
        assertNotNull(po1);
        
        r1 = requestRepository.saveAndFlush(new Request(pe1.getPersonId(),
                po1.getProductId(), 10L,Operation.CREDIT, Result.PENDING));
        assertNotNull(r1);
    ...
    public void requestViewRepositoryDemoTest() {
        ...
        lstRequestView.forEach(request -> 
            logger.info("Request - FindAll: {}.", request.toString()));
     }
}